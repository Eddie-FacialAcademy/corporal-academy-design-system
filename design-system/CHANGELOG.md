# Changelog — Corporal Academy Design System
...
- Anel de foco em duas camadas: `--focus` agora é `0 0 0 2px var(--bg),
  ...
  `#E88A92`, claro `#C2434E`). O anel antigo (accent com 55% de opacidade, valor
...
- `copy-deck.corporal-academy.json` no pacote como fonte canônica das strings.
### Alterado
