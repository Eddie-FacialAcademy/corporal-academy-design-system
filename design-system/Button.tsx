// Corporal Academy Design System — Button
...
export default function Button(props) {
    const {
        label = "Assinar a Corporal Academy",
        variant = "fill",
        size = "md",
        showIcon = true,
        iconPosition = "right",
...
addPropertyControls(Button, {
    label: { type: ControlType.String, title: "Texto", defaultValue: "Assinar a Corporal Academy" },
    variant: {
