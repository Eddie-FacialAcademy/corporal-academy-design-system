# Handoff — Corporal Academy Design System (estado em 2026-06-11)
...
- **URL pública:** https://eddie-facialacademy.github.io/corporal-academy-design-system/
- Repo público `corporal-academy-design-system` (conta `Eddie-FacialAcademy`), branch `main`, `index.html` na raiz.
- Pasta dedicada local: `_Claudio x Eddie/Corporal Academy - Design System/` (1 pasta por marca).
...
- `silka.css` · `corporal-academy-design-system.css` · `corporal-academy-design-tokens.json` · `Button.tsx` · `THEME.md` · `DESIGN-SYSTEM.md`.
...
## Deploy / git (durável)
- `.git` **fora do OneDrive**: `AppData\Local\gitdirs\corporal-academy-design-system`.
...
- Ainda não há projeto Framer / landing da Corporal Academy neste setup (só o design system).
